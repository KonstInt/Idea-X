...
import com.ovs_corp.bstorm.ui.videos.adapters.CommentAdapter;
import com.ovs_corp.bstorm.ui.videos.models.YoutubeCommentModel;
...
public class DetailsActivity extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private static String GOOGLE_YOUTUBE_API = "AIzaSyAB8RrkfY1hJFpbaRYKL1L-v4Yf_-A_-fo";
        ...
        @SuppressLint("StaticFieldLeak") YouTubeUriExtractor ytEx = new YouTubeUriExtractor(this) {
            ...
            public void onUrisAvailable(String videoID, String videoTitle, SparseArray<YtFile> ytFiles) {
                if (ytFiles != null) {
                  ...
                  {
                      e.printStackTrace();
                      Toast.makeText(DetailsActivity.this, "Произошла ошибка", Toast.LENGTH_SHORT).show();
                  }
    ...
    private class RequestDownloadVideoStream extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pDialog.setMessage("Видео скачивается, ожидайте...");
