...
import com.ovs_corp.bstorm.ui.home.VerticalScrollNews;
import com.ovs_corp.bstorm.ui.home.VerticalScrollideasActivity;
import com.ovs_corp.bstorm.ui.home.idea_create.NewIdea;
import com.ovs_corp.bstorm.ui.home.news_create.NewsSet;
import com.ovs_corp.bstorm.ui.home.news_create.NewsStatus;
import com.ovs_corp.bstorm.ui.profile.user.UserProfile;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                R.id.navigation_home, R.id.navigation_ideas, R.id.navigation_messages, R.id.navigation_notisfactoin).build();
    ...
    protected void onStart() {
        ...
        NewsStatus nss = new NewsStatus();
        nss.id= 4;
        nss.status = "ready";
        NewsSet ns  = new NewsSet(77, "Россети на ЦП", "Россети вышли на новый уровень, они являются кейсодержателями крупнейшего хакатона России","ff", "12.3.2222", true, "77", "Grisha","f", nss);
        NewsSet ns1  = new NewsSet(77, "Новый офис на марсе", "После длительного голосования было решено построить офис на марсе. Первым работником станет Илон Маск","ff", "12.3.2222", true, "77", "Grisha","f", nss);
        NewsSet ns2  = new NewsSet(77, "Digital Perspective", "Наконец выявлены победители финала ЦП. Ими является лучшая команда - Digital Perspective ","ff", "12.3.2222", true, "77", "Grisha","f", nss);


        AppInfo.news_cards.add( ns2);
        AppInfo.news_cards.add( ns1);
        AppInfo.news_cards.add( ns);
        if(currentUser == null) {
    ...
    public void openIdeas(View view) {
        Intent g = new Intent(this, VerticalScrollideasActivity.class);
        startActivity(g);
    }

    public void openNotice(View view) {
        Intent g = new Intent(this, Notifications.class);
        startActivity(g);
    }
}
